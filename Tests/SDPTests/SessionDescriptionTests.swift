...
final class SessionDescriptionTests: XCTestCase {
  ...
  func testDeserialize() {
    XCTAssertNoThrow(try SessionDescription.deserialize(from: source))
  }

  func testSerialize() throws {
    let sessionDescription = try SessionDescription.deserialize(from: source)
    XCTAssertEqual(sessionDescription.serialize(), source)
  }
